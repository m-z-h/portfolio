      ...
      <div className="px-3 py-5 mx-auto text-center sm:mx-6 md:mx-12 md:pt-5 md:mt-5 xl:mx-40">
        ...
        >
          ...
          <p
            ...
            data-aos-once="false"
            className="text-lg font-medium leading-relaxed text-[#15F5BA]"
          >
            My Works
          </p>
        </div>
        <div className="mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-12 sm:gap-x-3 md:gap-x-5 lg:gap-x-2 lg:gap-y-5 xl:gap-y-10 xl:gap-x-5 mt-4 md:mt-8 ">
          {ProjectsData.reverse().map((project) => (
            <div
              ...
              data-aos-once="false"
              key={project.id}
              className="group relative text-[#c115f5] flex flex-col flex-wrap h-80 w-[95%] mx-auto shadow-md md:shadow-lg rounded-xl "
            >
             <div>
             <img
                src={project.image}
              ...
              <div className="absolute  bg-slate-500 flex flex-col justify-center items-center bottom-0 left-0 right-0 h-0 overflow-hidden group-hover:h-full transition-[height_0.5s] duration-500 bg-darkblue rounded-xl">
                <h3 className="text-2xl font-medium text-[#15F5BA] my-2">
                  {project.name}
                </h3>
                <p className="px-2 text-lg font-bold text-black">{project.description}</p>
