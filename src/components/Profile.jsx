  ...
  return (
    ...
    >
      <div className="p-5 mx-auto gap-2 flex flex-col md:pt-12 md:px-7 lg:py-20 lg:flex-row-reverse items-center min-h-fit">
        ...
        >
          <img
            className="object-cover object-center bg-[#b9aeb6] border-4 border-green-600 pointer-events-none rounded-full backdrop-contrast-200 backdrop-brightness-200"
        ...
        <div className="lg:flex-grow lg:pr-4 lg:mr-14 flex flex-col md:mb-0 items-center text-center xl:scale-105">
          ...
          >
            Hello , I am{" "}
            <span className="text-green-500">{ProfileData.name}</span>
          </h2>
          <div
            data-aos="zoom-in-up"
            data-aos-duration="1500"
            data-aos-once="false"
            className="text-3xl text-green-500 mb-4 font-medium lg:inline-block"
          >
            &nbsp;
            <Typewriter
          ...
          >
            <button className="inline-flex font-medium text-white bg-black border-2 border-gray-400 py-3 px-7 focus:outline-none hover:border-violet-700 hover:text-green-500 rounded-full text-md xl:px-10">
              <Link
                to="contact"
                spy={true}
                smooth={true}
            ...
            <a href={ProfileData.resume} target="_blank" rel="noreferrer">
              <button className="inline-flex font-medium text-white bg-dark-orange border-2 border-gray-400 py-3 px-7 focus:outline-none hover:bg-cornsilk hover:border-violet-600 hover:text-green-500 rounded-full text-md xl:px-10">
                Get Resume
              </button>
            </a>
          </div>
