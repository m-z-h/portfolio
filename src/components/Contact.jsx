      ...
      <div className="px-3 py-5 mx-auto text-center md:mt-7 sm:mx-7 md:mx-12 lg:mx-32 xl:mx-56">
        <div id="contact" className="flex flex-col text-center w-full mb-4">
          ...
          <p
            ...
            data-aos-once="false"
              className="text-lg font-medium leading-relaxed text-[#1bd7e1] "
          >
            Let's keep in touch
          </p>
        </div>
        <div className="flex flex-col gap-2 md:flex-row w-full mx-auto rounded-xl bg-darkblue p-4 md:gap-7 lg:gap-9 lg:rounded-2xl xl:gap-10">
          ...
          >
            ...
            <div
              ...
              className="p-2 w-full"
            >
              <button className=" font-medium mx-auto my-3  text-white bg-gray-500 border-0 py-2 px-12 focus:outline-none hover:scale-110 hover:bg-[#1bd7e1] transition duration-500 rounded-xl text-lg">
                Send
              </button>
            </div>
          </form>
