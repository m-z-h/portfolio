      ...
      <div className="mx-auto max-w-6xl">
        <div id="experience" className="flex flex-col text-center mb-4 w-full ">
          <h1 className="text-3xl  text-white
           sm:text-4xl font-medium title-font mb-2">
            Experience
          </h1>
          <p
            data-aos="zoom-in"
            ...
            data-aos-once="false"
            className="text-lg mx-auto leading-relaxed font-medium text-dark-orange text-center text-[#FFD95F]"
          >
            ...
            return isLeft ? (
              ...
              >
                <div
                  ...
                  data-aos-once="false"
                  className="bg-[#0B192C] text-sky-50 col-start-1 col-end-5 p-2.5 md:p-4 rounded-lg my-4 ml-auto shadow-md"
                >
                  <h3 className="text-lg md:text-xl font-semibold mb-1">
                    {exp.title}
                  </h3>
                  <div className="flex flex-col md:flex-row md:items-center justify-between font-medium w-full gap-2 mb-2">
                    <h4 className="text-base text-[#D3E671]">{exp.company}</h4>
                    <p className="text-sm md:text-base text-[#D3E671]">
                      {exp.duration}
                    </p>
                  </div>
